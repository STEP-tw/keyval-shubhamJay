...
describe("parse basic key values", function() {
  ...
  it("parse when there are spaces after key", function() {
    let expected = new Parsed();
    expected['key'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("key =value"));
  });
...
describe("parse digits and other special chars", function() {
  ...
  it("parse keys with a single digit", function() {
    let expected = new Parsed();
    expected['1'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("1=value"));
  });

  it("parse keys with only multiple digits", function() {
    let expected = new Parsed();
    expected['123'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("123=value"));
  });

  it("parse keys with leading 0s", function() {
    let expected = new Parsed();
    expected['0123'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("0123=value"));
  });

  it("parse keys with underscores", function() {
    let expected = new Parsed();
    expected['first_name'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("first_name=value"));
  });

  it("parse keys with a single underscore", function() {
    let expected = new Parsed();
    expected['_'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("_=value"));
  });

  it("parse keys with multiple underscores", function() {
    let expected = new Parsed();
    expected['__'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("__=value"));
  });

  it("parse keys with alphabets and digits(digits leading)", function() {
    let expected = new Parsed();
    expected['0abc'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("0abc=value"));
  });

  it("parse keys with alphabets and digits(alphabets leading)", function() {
    let expected = new Parsed();
    expected['a0bc'] = 'value'
    chaiAssert.ownInclude(expected, kvParser.parse("a0bc=value"));
  });
});
...
describe("multiple keys", function() {
  ...
  it("parse more than one key", function() {
    ...
    chaiAssert.ownInclude(expected, kvParser.parse("key=value anotherkey=anothervalue"));
  });
...
describe("single values with quotes", function() {
  ...
  it("parse a single quoted value that has spaces in it", function() {
    let expected = new Parsed();
    expected['key'] = 'va lue'
    chaiAssert.ownInclude(expected, kvParser.parse("key=\"va lue\""));
  });
...
describe("multiple values with quotes", function() {
  it("parse more than one value with quotes", function() {
    ...
    chaiAssert.ownInclude(expected, kvParser.parse("key=\"va lue\" anotherkey=\"another value\""));
  });
...
describe("mixed values with both quotes and without", function() {
  ...
  it("parse simple values with and without quotes(quoted values first)", function() {
    ...
    expected['key'] = 'value';
    expected['anotherkey'] = "anothervalue";
    chaiAssert.ownInclude(expected, kvParser.parse("anotherkey=\"anothervalue\" key=value"));
  });
});
